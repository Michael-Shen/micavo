(function () {
  ...
  const translations = {
    'zh-Hant': {
      ...
      'Designed for ages 13–20': '適合 13–20 歲', 'English · 繁中 · 日本語': 'English · 繁中 · 日本語', 'Transparent method': '透明計算方式',
      ...
      'Built for teens and young adults ages 13–20, with a guardian path where required.': '為 13–20 歲青少年與年輕成人設計，並在必要時提供監護人流程。',
      ...
      'Who is TallCenter designed for?': 'TallCenter 適合誰？', 'TallCenter currently supports teens and young adults ages 13–20. A parent or guardian must manage or consent to use where local law requires it. Adults whose growth plates have closed should expect little or no natural height increase.': 'TallCenter 目前支援 13–20 歲青少年與年輕成人。當地法律要求時，須由父母或監護人管理或同意使用。生長板已閉合的成人，自然身高通常不會或只會有極少變化。',
      ...
      'Your data, your control': '你的資料，由你掌控', 'Permanently delete your account and associated app data from Settings, or contact us to request a copy of your data.': '你可以在設定中永久刪除帳號與相關 App 資料，或聯絡我們申請資料副本。',
    ...
    ja: {
      ...
      'Join early access ↗': '先行アクセスに参加 ↗', 'Explore the growth tracker': '成長トラッカーを見る', 'Designed for ages 13–20': '13〜20歳向け', 'English · 繁中 · 日本語': 'English · 繁中 · 日本語', 'Transparent method': '透明な計算方法',
      ...
      'How TallCenter works': 'TallCenterの仕組み', 'Two minutes to clarity. One day at a time after that.': '2分で理解。その後は一日ずつ。', 'Built for teens and young adults ages 13–20, with a guardian path where required.': '13〜20歳の青少年・若年成人向け。必要な場合は保護者向けフローも用意しています。',
      ...
      'Who is TallCenter designed for?': 'TallCenterは誰向けですか？', 'TallCenter currently supports teens and young adults ages 13–20. A parent or guardian must manage or consent to use where local law requires it. Adults whose growth plates have closed should expect little or no natural height increase.': '現在13〜20歳の青少年・若年成人に対応しています。法律で必要な場合は保護者の管理・同意が必要です。成長板が閉じた成人は自然な身長増加がほとんど期待できません。',
  ...
  function applyLanguage(language, updateUrl) {
    ...
    if (metaDescription) {
      metaDescription.content = lang === 'zh-Hant'
        ? 'TallCenter 根據家族身高預估成年身高範圍，比較世界各國的相對身高百分位，並協助建立健康習慣。適合 13–20 歲。'
        : lang === 'ja'
          ? 'TallCenterは家族の身長から成人身長範囲を推定し、世界各国の相対身長パーセンタイルを比較し、健康習慣の形成を支えます。13〜20歳向け。'
          : originalDescription;
    }
